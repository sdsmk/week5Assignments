...
class Cake {
    ...
    private final double honey; //spoons
    /*static void met1()
    {
    ...
    public static class Builder {
        ...
        public Builder honey(double number){this.honey = number; System.out.println(this);return this; }
	...
	//any other buzsiness methods can exist here
    @Override
